    ...
    def text_split(self,data,data_type):
       ...
       #split data by data_type
        ...
        #loop through the operation
            ...
            with open(self.file_path+'/fasttext_'+data_type+'.txt','w',encoding='utf-8')as f: 
...
#        print("self.label_domain",self.label_domain)
        ...
        self.classifier=fasttext.supervised(self.file_path+'/fasttext_trainingset.txt',self.file_path+'/fasttext_test.model',label_prefix='__label__',
                                       epoch=200,min_count=3,word_ngrams=3,ws=10,thread=32,lr=0.1,dim=200,bucket=5000000)
        ...
        test_set1 = open(self.file_path+'/fasttext_test_split.txt','r',encoding='utf-8-sig')
